...
export VSO_AGENT_IGNORE=AZP_TOKEN,AZP_TOKEN_FILE,ARTIFACTORY_USERNAME,ARTIFACTORY_PASSWORD,GITHUB_USERNAME,GITHUB_PASSWORD,VAULT_ROLE_ID,VAULT_SECRET_ID
